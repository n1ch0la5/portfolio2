...
const projects = ref([
  ...
  {id: 3, title: 'Ringlead Sales Dialer', url: '', link: '', description: 'CF.com\'s Customer facing website.', about: "Worked with a team of developers to create an internal sales dialer in Vite/Vue/Typescript. I was in charge of creating pinia stores and using websockets and middle out compression to connect our front and back ends for lightning quick response times.", name: 'Ringlead', image: 'ringlead', logos: ['vue']},
