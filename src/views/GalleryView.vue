...
{id: 2, title: 'CF Hub', description: 'Cardinal Financial Employee hub.', about: "As my inaugural project with Cardinal Financial, I had the privilege of working alongside two other developers to build and maintain a new employee-facing hub, complete with company announcements, achievements, and other engaging features. Utilizing Wordpress and Vue.js, we were able to create a dynamic and user-friendly intranet that fosters communication and collaboration within the organization. Overall, it was a rewarding experience and I am excited to see how this resource continues to support and enhance the experience of our employees.", name: 'thehub', image: 'thehub', logos: ['wordpress', 'vue']},
{id: 3, title: 'Total Mortgage', description: 'Customer facing website', about: "One of my first significant projects using the Laravel framework was the development of totalmortgage.com. Alongside my team, I employed Laravel and Vue.js to create a comprehensive mortgage website that featured a customer portal for tracking loan progress (think Dominos pizza tracker for mortgages). The result was a user-friendly and efficient platform that streamlined the mortgage process for both customers and the company. This project presented a great opportunity for me to demonstrate my skills and expand my expertise in Laravel and Vue.js, and it was both challenging and rewarding.", name: 'totalmortgage.com', image: 'tms_com', logos: ['laravel', 'vue']},
